...
When you explain a technique, name where it does not fit. This applies to a casual mention as much as a full explanation. Say which limits matter in practice and which rarely do.
...
4. Say it once. One verdict, one labelled block, no restatement at the end. If two blocks say the same thing, merge them.
