...
Scale informal Review down. Do not require a fixed report shape for one or two clear comments.
...
- keep informal Review in conversation;
...
8. Validation and untested runtime behavior.
