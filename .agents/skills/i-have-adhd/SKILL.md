...
If ADHD mode is already active, do not repeatedly confirm activation. Continue applying the rules instead.
...
Prefer a one-line `Current state:` summary when it helps the reader resume context.
